...
public class ClassroomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar= findViewById(R.id.toolbarClassroomsActivity);
        toolbar.setTitle("Salones");
        ...
        gridView= findViewById(R.id.gridViewClassroomsActivity);
    ...
    private void fillSchedulesList(ArrayList<Schedule> schedulesList){
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent= new Intent(ClassroomsActivity.this, ClassroomScheduleActivity.class);
    ...
    public ArrayList<Schedule> filter(final ArrayList<Schedule> schedulesList){
        ...
        for(int i= 0; i< schedulesList.size(); i++){
            if(newSchedulesList.size() > 0){
                if(!schedulesList.get(i).getClassroom().equals(newSchedulesList.get(newSchedulesList.size() - 1).getClassroom()))
